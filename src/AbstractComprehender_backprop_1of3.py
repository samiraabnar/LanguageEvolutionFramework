...
class ListernerLSTM(object):
    ...
    def init_lstm_weights(self):
        U_input = random_normal_matrix((self.hidden_dim, self.input_dim))

        U_forget = random_normal_matrix((self.hidden_dim, self.input_dim))

        U_output = random_normal_matrix((self.hidden_dim, self.input_dim))

        W_input = random_normal_matrix((self.hidden_dim, self.hidden_dim))

        W_forget = random_normal_matrix((self.hidden_dim, self.hidden_dim))

        W_output = random_normal_matrix((self.hidden_dim, self.hidden_dim))

        U = random_normal_matrix((self.hidden_dim, self.input_dim))

        W = random_normal_matrix((self.hidden_dim, self.hidden_dim))
        ...
        U_input_2 = random_normal_matrix((self.hidden_dim, self.hidden_dim))

        U_forget_2 = random_normal_matrix((self.hidden_dim, self.hidden_dim))

        U_output_2 = random_normal_matrix((self.hidden_dim, self.hidden_dim))

        W_input_2 = random_normal_matrix((self.hidden_dim, self.hidden_dim))

        W_forget_2 = random_normal_matrix((self.hidden_dim, self.hidden_dim))

        W_output_2 = random_normal_matrix((self.hidden_dim, self.hidden_dim))

        U_2 = random_normal_matrix((self.hidden_dim, self.hidden_dim))

        W_2 = random_normal_matrix((self.hidden_dim, self.hidden_dim))
        ...
        O_w = random_normal_matrix((self.output_dim, self.hidden_dim))
